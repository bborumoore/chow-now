...
const chowSeed = [
  {
    ...
    order: "Number 6 Meal",
    orderItems: {
      foodName: "Single Cheeseburger with fries and a coke",
      foodPrice: 8.47,
      foodNotes: "No tomato and extra salt on fries"
    },
    runner: [userID], // Maybe create a seperate uuid for runners and members that are generated every run
    members: [userID]
  },

  {
    run: "Buffalo Wild Wings",
    order: "10 Boneless Wings",
    orderItems: {
      foodName: "5 Honey BBQ, 5 Asian zing",
      foodPrice: 10.63,
      foodNotes: "Ranch, Celery, and Carrots"
    },
    runner: [userID],
    members: [userID]
  },
...
db.Book
  .deleteMany({})
  .then(() => db.Book.collection.insertMany(chowSeed))
  .then(data => {
